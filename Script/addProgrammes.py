...
def insert():
    ...
    try:
        ...
        insert_script = 'INSERT INTO programmes (name,faculty_id) VALUES (%s,%s)'
        with open("C:/Users/savac/Desktop/Feedback/CSV/specializari.csv","r",encoding='iso=8859-2') as csv_file:
